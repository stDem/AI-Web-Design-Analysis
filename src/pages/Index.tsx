...
const Index = () => {
  ...
  return (
    <div className="min-h-screen paper-texture" style={{ fontFamily: '"Comic Sans MS", cursive' }}>
      ...
      {/* Header with scroll hide effect */}
      <div className={`sketch-header fixed top-0 z-40 py-4 w-full transition-transform duration-300 ${
            ...
            <div className="flex items-center space-x-4">
              <div className="sketch-border bg-white p-2 doodle-decoration">
                <img 
                  ...
                  className="w-20 h-20 object-contain sketchy-shadow"
                />
              </div>
              <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-32">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-6 mt-10 hand-drawn-line">
